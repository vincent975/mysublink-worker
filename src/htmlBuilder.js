...
<a href="https://github.com/vincent975/mysublink-worker" target="_blank" rel="noopener noreferrer" class="github-link">
        ...
        <div class="form-section-title d-flex align-items-center">
          ...
          <span class="tooltip-icon ms-2">
            ...
            <span class="tooltip-content">
              此功能是实验性的，可能无法按预期工作。您可以在此处粘贴自己的基本配置。转到 <a href="https://github.com/vincent975/mysublink-worker/blob/main/docs/base-config.md" target="_blank">文档</a> 了解更多信息。
            </span>
          </span>
        </div>
        <div class="mb-3">
